        ...
        for video_file in video_files:
            ...
            messages = [{
                ...
                "content": [
                    ...
                    {"type": "text", "text": "Describe this video in detail. When writing descriptions, focus on detailed, chronological descriptions of actions, composition and scenes. Include specific movements, appearances, camera angles, framing, and environmental details - all in a single flowing paragraph. Start directly with the action, and keep descriptions literal and precise. For best results, build your prompts using this structure: Start with main action in a single sentence. Add specific details about movements and gestures. Describe character and object appearances precisely. Describe the framing and composition of any people, for example \"The person is framed from the waist up\". Include background and environment details.Specify camera angles and movements.Describe lighting and colors.Note any changes or sudden events."},
                ],
            }]
